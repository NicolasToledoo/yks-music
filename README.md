...
- Configurações integradas (formato de áudio, navegador, dependências, informações do sistema)
...
Comandos do Menu Principal
   ...
   ⚙️   Configurações          - Pasta, formato, cookies, dependências, sistema
   ❓  Ajuda                  - Documentação
...
Cookies do Navegador (selecionar, redetectar)
